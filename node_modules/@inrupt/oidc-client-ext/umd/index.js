(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('oidc-client'), require('@inrupt/solid-client-authn-core'), require('node-jose'), require('jsonwebtoken'), require('uuid'), require('form-urlencoded')) :
  typeof define === 'function' && define.amd ? define(['exports', 'oidc-client', '@inrupt/solid-client-authn-core', 'node-jose', 'jsonwebtoken', 'uuid', 'form-urlencoded'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.OidcDpopClient = {}, global.oidcClient, global.solidClientAuthnCore, global.nodeJose, global.JWT, global.uuid, global.formurlencoded));
}(this, (function (exports, oidcClient, solidClientAuthnCore, nodeJose, JWT, uuid, formurlencoded) { 'use strict';
